...
st.title("ประเมินความเสี่ยงต่อโรคหลอดเลือดหัวใจ")
    ...
    if prompt:
        ...
        with st.chat_message("assistant"):
            if st.session_state.messages:
                ...
                if "low risk" in assistant_response:
                    st.write("Please go to [this link](https://www.samitivejhospitals.com/th/program/detail/heart-health-screening-program-heart-1-2022) สำหรับความเสี่ยงระดับต่ำและปานกลาง")
                elif "high risk" in assistant_response or "moderate risk" in assistant_response:
                    st.write("Please go to [this link](https://www.samitivejhospitals.com/th/center/detail/%E0%B8%A8%E0%B8%B9%E0%B8%99%E0%B8%A2%E0%B9%8C%E0%B8%AB%E0%B8%B1%E0%B8%A7%E0%B9%83%E0%B8%88) เพื่อการประเมินระดับเสี่ยงสูง")
                else:
